...
\begin{itemize}
    ...
    \item \emph{Audio Requirements}:
        \begin{itemize}
            ...
            \item \textbf{Note}: The game remains playable with audio disabled, but provides a richer experience with sound enabled.
        \end{itemize}
\end{itemize}
...
\begin{itemize}
  ...
  \item Source repository hosted on RiouxSVN, accessible at \url{https://svn.riouxsvn.com/semestergames/}
\end{itemize}
...
\begin{itemize}
  ...
  \item Volume controls, with mute/unmute toggle
\end{itemize}
